...
iar\bin\icc430.exe -ODebug\Obj\ -e -K -gA -s9 -RCODE -r0 -LDebug\List\ -q -T -t8 -ADebug\List\ -Iiar\inc\ adc.c
iar\bin\icc430.exe -ODebug\Obj\ -e -K -gA -s9 -RCODE -r0 -LDebug\List\ -q -T -t8 -ADebug\List\ -Iiar\inc\ msp_main.c
iar\bin\icc430.exe -ODebug\Obj\ -e -K -gA -s9 -RCODE -r0 -LDebug\List\ -q -T -t8 -ADebug\List\ -Iiar\inc\ timer_a.c
