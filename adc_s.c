...
void init_adc(void){
    ...
    //ADC12CLK=3 686 400
    //SHT0_8 t_sample=4*ADC12CLK*64=14400 ѓж    0.00006944
    ...
    //      000 VR+ = A VCC         and VR- = A VSS - ®в 0 ¤® ЇЁв ­Ёп
    //      001 VR+ = V REF+        and VR- = A VSS - ®в 0 ¤® ў­гва. ®Ї®а­.
    //      010 VR+ = Ve REF+       and VR- = A VSS - ®в 0 ¤® ў­Ґи. ®Ї®а­.
