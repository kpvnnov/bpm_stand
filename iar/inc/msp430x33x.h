...
#define PORT0_VECTOR        (0 * 2)  /* 0xFFE0 Port 0 Bits 2-7 [Lowest Priority] */
#define BASICTIMER_VECTOR   (1 * 2)  /* 0xFFE2 Basic Timer */
#define PORT1_VECTOR        (2 * 2)  /* 0xFFE4 Port 1 */
#define PORT2_VECTOR        (3 * 2)  /* 0xFFE6 Port 2 */
#define TIMERPORT_VECTOR    (4 * 2)  /* 0xFFE8 Timer/Port */
#define UARTTX_VECTOR       (6 * 2)  /* 0xFFEC UART Transmit */
#define UARTRX_VECTOR       (7 * 2)  /* 0xFFEE UART Receive */
#define TIMERA1_VECTOR      (8 * 2)  /* 0xFFF0 Timer A CC1-4, TA */
#define TIMERA0_VECTOR      (9 * 2)  /* 0xFFF2 Timer A CC0 */
#define WDT_VECTOR          (10 * 2) /* 0xFFF4 Watchdog Timer */
#define IO1_VECTOR          (12 * 2) /* 0xFFF8 Dedicated IO (P0.1) */
#define IO0_VECTOR          (13 * 2) /* 0xFFFA Dedicated IO (P0.0) */
